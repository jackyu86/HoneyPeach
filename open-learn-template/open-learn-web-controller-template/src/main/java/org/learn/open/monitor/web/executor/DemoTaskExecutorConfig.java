...
@Configuration
@ComponentScan("org.learn.open.web.executor")
@EnableAsync//开启异步支持
public class DemoTaskExecutorConfig implements AsyncConfigurer {
     ...
     */
    @Service
    public static class NormalAsyncContext {
        protected Logger log = LoggerFactory.getLogger(org.learn.open.monitor.web.executor.NormalAsyncContext.class);
