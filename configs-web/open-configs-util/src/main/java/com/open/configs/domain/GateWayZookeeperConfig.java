...
/**
 */
public class GateWayZookeeperConfig {
	...
	public String getDefaultZKpath() {
		return defaultZKpath;
	}

	public void setDefaultZKpath(String defaultZKpath) {
		this.defaultZKpath = defaultZKpath;
	}
